 ...
 class Lupa_password extends CI_Controller {  
     ...
     {  
         ...
         if($this->form_validation->run() == FALSE) {  
             ...
             $message = '';             
             $message .= '<strong>Hi, you receive this email because there is a request to change your password. </strong><br>';  
             $message .= '<strong>Please click this link : </strong> ' . $link;         
   
             $this->load->model("emails");
			 $this->emails->send($message,$email);
			 $this->session->set_flashdata('sukses', 'email has sent'); 			 
